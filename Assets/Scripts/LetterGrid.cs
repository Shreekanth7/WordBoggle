    ...
    public void GenerateCustomGrid(List<GridTile> gridData)
    {
        ...
        for (int x = 0; x < gridSizeX; x++)
        {
            for (int y = 0; y < gridSizeY; y++)
            {
                ...
                // Handle tile type (Normal, Blocked, Bonus)
    ...
    public void RemoveTilesAndRefill(List<LetterTile> usedTiles)
{
    ...
    // Track already removed tiles to prevent duplicate removals
    ...
    foreach (LetterTile tile in usedTiles)
    {
        ...
        // Check if this tile was already removed
        ...
        if (grid[x, y] != null)
        {
            ...
            grid[x, y] = null;
            removedTiles.Add(tilePos); // ✅ Mark this tile as removed
        }
